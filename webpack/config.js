...
function getAliasFor(packageName) {
    const fullPackageName = `@lindas/${packageName}`;
...
exports.genericConfig = {
    ...
    resolve: {
        modules: [
            ...
            path.resolve(__dirname, "./../packages/yasgui-utils/node_modules"),
        ],
        alias: Object.assign(Object.assign(Object.assign(Object.assign({}, getAliasFor("yasgui")), getAliasFor("yasr")), getAliasFor("yasqe")), getAliasFor("yasgui-utils")),
...
const config = Object.assign(Object.assign({}, exports.genericConfig), { stats: {
        ...
        Utils: path.resolve(__dirname, "./../packages/yasgui-utils/src/index.ts"),
    } });
