...
import { default as Yasqe, PartialConfig as YasqeConfig, RequestConfig } from "@lindas/yasqe";
import { default as Yasr, Config as YasrConfig } from "@lindas/yasr";
import { addClass, removeClass } from "@lindas/yasgui-utils";
require("./index.scss");
require("@lindas/yasr/src/scss/global.scss");
if (window) {
