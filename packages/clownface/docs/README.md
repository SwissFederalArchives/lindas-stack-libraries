...
[![Build Status](https://github.com/SwissFederalArchives/lindas-clownface/workflows/CI/badge.svg)](https://github.com/SwissFederalArchives/lindas-clownface/actions)
[![NPM Version](https://img.shields.io/npm/v/lindas-clownface.svg?style=flat)](https://npm.im/lindas-clownface)
...
A Typescript declaration package [`@types/clownface`](https://npm.im/@types/clownface) is available for the original clownface package.
