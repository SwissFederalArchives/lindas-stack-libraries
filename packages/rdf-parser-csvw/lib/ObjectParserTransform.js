...
export default class ObjectParserTransform extends Transform {
    ...
    processTableGroup() {
        this.push(this.factory.quad(this.tableGroupNode, this.ns.type, this.ns.TableGroup));
    }
    processTable() {
        this.push(this.factory.quad(this.tableGroupNode, this.ns.table, this.tableNode));
        this.push(this.factory.quad(this.tableNode, this.ns.type, this.ns.Table));
        this.push(this.factory.quad(this.tableNode, this.ns.url, this.factory.namedNode(this.baseIRI)));
    ...
    processRow(line, row) {
        ...
        this.push(this.factory.quad(this.tableNode, this.ns.row, rowNode));
        this.push(this.factory.quad(rowNode, this.ns.type, this.ns.Row));
        const rowData = {
            ...row,
        ...
        this.push(this.factory.quad(rowNode, this.ns.describes, describesNode));
        this.tableSchema.columns({ contentLine: this.contentLine, row: rowData }).forEach((column) => {
            this.push(this.factory.quad(column.subject || describesNode, column.property, column.value));
        });
        // rownum
        this.push(this.factory.quad(rowNode, this.ns.rownum, this.factory.literal(this.contentLine.toString(), this.ns.integer)));
        // url
        const rowUrl = this.factory.namedNode(this.baseIRI + '#row=' + line);
        this.push(this.factory.quad(rowNode, this.ns.url, rowUrl));
        return Promise.resolve();
    }
    copySubgraph(quads, subject) {
        quads.forEach((quad) => {
            this.push(this.factory.quad(subject || quad.subject, quad.predicate, quad.object));
