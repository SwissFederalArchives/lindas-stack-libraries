...
declare const _default: <D extends DatasetCore>(createConstructor: (env: Environment<FormatsFactory | DataFactory | TermMapFactory>) => DatasetCtor<D>) => {
    new (): {
        dataset: FactoryMethod<D>;
        init(this: Environment<FormatsFactory | DatasetFactoryExt<D> | DataFactory | TermMapFactory>): void;
    };
};
export default _default;
//# sourceMappingURL=DatasetFactoryExt.d.ts.map